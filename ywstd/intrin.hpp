...
template<int imm8> inline m128 mm_dp_ps(const m128& a, const m128& b) noexcept { return _mm_dp_ps(a, b, imm8); }
template<int imm8> inline m256 mm256_dp_ps(const m256& a, const m256& b) noexcept { return _mm256_dp_ps(a, b, imm8); }
template<int imm8> inline m128d mm_dp_pd(const m128d& a, const m128d& b) noexcept { return _mm_dp_pd(a, b, imm8); }
...
template<int imm8> inline m128 mm_cmp_ss(const m128& a, const m128& b) noexcept { return _mm_cmp_ss(a, b, imm8); }
template<int imm8> inline m128 mm_cmp_ps(const m128& a, const m128& b) noexcept { return _mm_cmp_ps(a, b, imm8); }
template<int imm8> inline m256 mm256_cmp_ps(const m256& a, const m256& b) noexcept { return _mm256_cmp_ps(a, b, imm8); }
template<int imm8> inline m128d mm_cmp_sd(const m128d& a, const m128d& b) noexcept { return _mm_cmp_sd(a, b, imm8); }
template<int imm8> inline m128d mm_cmp_pd(const m128d& a, const m128d& b) noexcept { return _mm_cmp_pd(a, b, imm8); }
template<int imm8> inline m256d mm256_cmp_pd(const m256d& a, const m256d& b) noexcept { return _mm256_cmp_pd(a, b, imm8); }
...
template<int imm8> inline m128i mm_alignr_epi8(const m128i& a, const m128i& b) noexcept { return _mm_alignr_epi8(a, b, imm8); }
template<int imm8> inline m256i mm256_alignr_epi8(const m256i& a, const m256i& b) noexcept { return _mm256_alignr_epi8(a, b, imm8); }
...
template<int imm8> inline m128i mm_mpsadbw_epu8(const m128i& a, const m128i& b) noexcept { return _mm_mpsadbw_epu8(a, b, imm8); }
template<int imm8> inline m256i mm256_mpsadbw_epu8(const m256i& a, const m256i& b) noexcept { return _mm256_mpsadbw_epu8(a, b, imm8); }
...
ywstd_intrin_macro(m128i, mm_packus_epi16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_packus_epi16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_packus_epi32, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_packus_epi32, (const m256i& a, const m256i& b), (a, b))

ywstd_intrin_macro(m128i, mm_move_epi64, (const m128i& a), (a))
ywstd_intrin_macro(m128d, mm_move_sd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m128, mm_move_ss, (const m128& a, const m128& b), (a, b))
ywstd_intrin_macro(m128d, mm_movedup_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_movedup_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_movehdup_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_movehdup_ps, (const m256& a), (a))
ywstd_intrin_macro(m128, mm_movehl_ps, (const m128& a, const m128& b), (a, b))
ywstd_intrin_macro(m128, mm_moveldup_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_moveldup_ps, (const m256& a), (a))
ywstd_intrin_macro(m128, mm_movelh_ps, (const m128& a, const m128& b), (a, b))

ywstd_intrin_macro(m128i, mm_avg_epu16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_avg_epu16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_avg_epu8, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_avg_epu8, (const m256i& a, const m256i& b), (a, b))

ywstd_intrin_macro(m128d, mm_cdfnorm_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_cdfnorm_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_cdfnorm_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_cdfnorm_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_cdfnorminv_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_cdfnorminv_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_cdfnorminv_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_cdfnorminv_ps, (const m256& a), (a))

ywstd_intrin_macro(m256d, mm256_erf_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_erf_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_erf_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_erfc_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_erfc_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_erfc_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_erfc_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_erfcinv_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_erfcinv_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_erfcinv_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_erfcinv_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_erfinv_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_erfinv_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_erfinv_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_erfinv_ps, (const m256& a), (a))
...
ywstd_intrin_macro(m128i, mm_set_epi16, (const short e7, const short e6, const short e5, const short e4, const short e3, const short e2, const short e1, const short e0), (e7, e6, e5, e4, e3, e2, e1, e0))
...
ywstd_intrin_macro(m128i, mm_set_epi32, (const int e3, const int e2, const int e1, const int e0), (e3, e2, e1, e0))
ywstd_intrin_macro(m256i, mm256_set_epi32, (const int e7, const int e6, const int e5, const int e4, const int e3, const int e2, const int e1, const int e0), (e7, e6, e5, e4, e3, e2, e1, e0))
ywstd_intrin_macro(m128i, mm_set_epi64x, (const long long e1, const long long e0), (e1, e0))
ywstd_intrin_macro(m256i, mm256_set_epi64x, (const long long e3, const long long e2, const long long e1, const long long e0), (e3, e2, e1, e0))
ywstd_intrin_macro(m128d, mm_set_pd, (const double e1, const double e0), (e1, e0))
ywstd_intrin_macro(m256d, mm256_set_pd, (const double e3, const double e2, const double e1, const double e0), (e3, e2, e1, e0))
ywstd_intrin_macro(m128, mm_set_ps, (const float e3, const float e2, const float e1, const float e0), (e3, e2, e1, e0))
ywstd_intrin_macro(m256, mm256_set_ps, (const float e7, const float e6, const float e5, const float e4, const float e3, const float e2, const float e1, const float e0), (e7, e6, e5, e4, e3, e2, e1, e0))
ywstd_intrin_macro(m128d, mm_set_sd, (const double a), (a))
ywstd_intrin_macro(m128, mm_set_ss, (const float a), (a))

ywstd_intrin_macro(m128i, mm_set1_epi8, (const char a), (a))
ywstd_intrin_macro(m256i, mm256_set1_epi8, (const char a), (a))
ywstd_intrin_macro(m128i, mm_set1_epi16, (const short a), (a))
ywstd_intrin_macro(m256i, mm256_set1_epi16, (const short a), (a))
ywstd_intrin_macro(m128i, mm_set1_epi32, (const int a), (a))
ywstd_intrin_macro(m256i, mm256_set1_epi32, (const int a), (a))
inline m128i mm_set1_epi64x(const long long a) { return _mm_set1_epi64x(a); }
inline m256i mm256_set1_epi64x(const long long a) { return _mm256_set1_epi64x(a); }
...
ywstd_intrin_macro(m128d, mm_set1_pd, (const double a), (a))
ywstd_intrin_macro(m256d, mm256_set1_pd, (const double a), (a))
ywstd_intrin_macro(m128, mm_set1_ps, (const float a), (a))
ywstd_intrin_macro(m256, mm256_set1_ps, (const float a), (a))
inline m128d mm_set_pd1(const double a) { return _mm_set1_pd(a); }
inline m128 mm_set_ps1(const float a) { return _mm_set1_ps(a); }
...
ywstd_intrin_macro(m128i, mm_setr_epi16, (const short e0, const short e1, const short e2, const short e3, const short e4, const short e5, const short e6, const short e7), (e0, e1, e2, e3, e4, e5, e6, e7))
...
ywstd_intrin_macro(m128i, mm_setr_epi32, (const int e0, const int e1, const int e2, const int e3), (e0, e1, e2, e3))
ywstd_intrin_macro(m256i, mm256_setr_epi32, (const int e0, const int e1, const int e2, const int e3, const int e4, const int e5, const int e6, const int e7), (e0, e1, e2, e3, e4, e5, e6, e7))
inline m128i mm_setr_epi64(const long long e0, const long long e1) { return _mm_set_epi64x(e1, e0); }
inline m128i mm_setr_epi64x(const long long e0, const long long e1) { return _mm_set_epi64x(e1, e0); }
...
inline m256i mm256_setr_epi64x(const long long e0, const long long e1, const long long e2, const long long e3) { return _mm256_setr_epi64x(e0, e1, e2, e3); }
ywstd_intrin_macro(m128d, mm_setr_pd, (const double e0, const double e1), (e0, e1))
ywstd_intrin_macro(m256d, mm256_setr_pd, (const double e0, const double e1, const double e2, const double e3), (e0, e1, e2, e3))
ywstd_intrin_macro(m128, mm_setr_ps, (const float e0, const float e1, const float e2, const float e3), (e0, e1, e2, e3))
ywstd_intrin_macro(m256, mm256_setr_ps, (const float e0, const float e1, const float e2, const float e3, const float e4, const float e5, const float e6, const float e7), (e0, e1, e2, e3, e4, e5, e6, e7))

ywstd_intrin_macro(m128i, mm_setzero_si128, (), ())
ywstd_intrin_macro(m256i, mm256_setzero_si256, (), ())
ywstd_intrin_macro(m128d, mm_setzero_pd, (), ())
ywstd_intrin_macro(m256d, mm256_setzero_pd, (), ())
ywstd_intrin_macro(m128, mm_setzero_ps, (), ())
ywstd_intrin_macro(m256, mm256_setzero_ps, (), ())

ywstd_intrin_macro_imm8(m256i, mm256_bslli_epi128, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_bslli_si128, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_bsrli_epi128, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_bsrli_si128, (const m128i& a), (a, imm8))

ywstd_intrin_macro(m128i, mm_sll_epi16, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sll_epi16, (const m256i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m128i, mm_sll_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sll_epi32, (const m256i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m128i, mm_sll_epi64, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sll_epi64, (const m256i& a, const m128i& count), (a, count))

ywstd_intrin_macro_imm8(m128i, mm_slli_epi16, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_slli_epi16, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_slli_epi32, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_slli_epi32, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_slli_epi64, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_slli_epi64, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_slli_si128, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_slli_si256, (const m256i& a), (a, imm8))

ywstd_intrin_macro(m128i, mm_sllv_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sllv_epi32, (const m256i& a, const m256i& count), (a, count))
ywstd_intrin_macro(m128i, mm_sllv_epi64, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sllv_epi64, (const m256i& a, const m256i& count), (a, count))

ywstd_intrin_macro(m128i, mm_sra_epi16, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sra_epi16, (const m256i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m128i, mm_sra_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_sra_epi32, (const m256i& a, const m128i& count), (a, count))

ywstd_intrin_macro_imm8(m128i, mm_srai_epi16, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srai_epi16, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_srai_epi32, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srai_epi32, (const m256i& a), (a, imm8))

ywstd_intrin_macro(m128i, mm_srav_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srav_epi32, (const m256i& a, const m256i& count), (a, count))

ywstd_intrin_macro(m128i, mm_srl_epi16, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srl_epi16, (const m256i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m128i, mm_srl_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srl_epi32, (const m256i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m128i, mm_srl_epi64, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srl_epi64, (const m256i& a, const m128i& count), (a, count))

ywstd_intrin_macro_imm8(m128i, mm_srli_epi16, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srli_epi16, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_srli_epi32, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srli_epi32, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_srli_epi64, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srli_epi64, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_srli_si128, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_srli_si256, (const m256i& a), (a, imm8))

ywstd_intrin_macro(m128i, mm_srlv_epi32, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srlv_epi32, (const m256i& a, const m256i& count), (a, count))
ywstd_intrin_macro(m128i, mm_srlv_epi64, (const m128i& a, const m128i& count), (a, count))
ywstd_intrin_macro(m256i, mm256_srlv_epi64, (const m256i& a, const m256i& count), (a, count))

ywstd_intrin_macro(m128i, mm_abs_epi8, (const m128i& a), (a))
ywstd_intrin_macro(m256i, mm256_abs_epi8, (const m256i& a), (a))
ywstd_intrin_macro(m128i, mm_abs_epi16, (const m128i& a), (a))
ywstd_intrin_macro(m256i, mm256_abs_epi16, (const m256i& a), (a))
ywstd_intrin_macro(m128i, mm_abs_epi32, (const m128i& a), (a))
ywstd_intrin_macro(m256i, mm256_abs_epi32, (const m256i& a), (a))

ywstd_intrin_macro(m128d, mm_ceil_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_ceil_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_ceil_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_ceil_ps, (const m256& a), (a))
ywstd_intrin_macro(m128d, mm_ceil_sd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m128, mm_ceil_ss, (const m128& a, const m128& b), (a, b))

ywstd_intrin_macro(m128d, mm_floor_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_floor_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_floor_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_floor_ps, (const m256& a), (a))
ywstd_intrin_macro(m128d, mm_floor_sd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m128, mm_floor_ss, (const m128& a, const m128& b), (a, b))

ywstd_intrin_macro(m128i, mm_max_epi8, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epi8, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_max_epi16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epi16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_max_epi32, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epi32, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_max_epu8, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epu8, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_max_epu16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epu16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_max_epu32, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_max_epu32, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128d, mm_max_pd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m256d, mm256_max_pd, (const m256d& a, const m256d& b), (a, b))
ywstd_intrin_macro(m128, mm_max_ps, (const m128& a, const m128& b), (a, b))
ywstd_intrin_macro(m256, mm256_max_ps, (const m256& a, const m256& b), (a, b))
ywstd_intrin_macro(m128d, mm_max_sd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m128, mm_max_ss, (const m128& a, const m128& b), (a, b))

ywstd_intrin_macro(m128i, mm_min_epi8, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epi8, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_min_epi16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epi16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_min_epi32, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epi32, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_min_epu8, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epu8, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_min_epu16, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epu16, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128i, mm_min_epu32, (const m128i& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_min_epu32, (const m256i& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128d, mm_min_pd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m256d, mm256_min_pd, (const m256d& a, const m256d& b), (a, b))
ywstd_intrin_macro(m128, mm_min_ps, (const m128& a, const m128& b), (a, b))
ywstd_intrin_macro(m256, mm256_min_ps, (const m256& a, const m256& b), (a, b))
ywstd_intrin_macro(m128d, mm_min_sd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m128, mm_min_ss, (const m128& a, const m128& b), (a, b))

ywstd_intrin_macro_imm8(m128d, mm_round_pd, (const m128d& a), (a, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_round_pd, (const m256d& a), (a, imm8))
ywstd_intrin_macro_imm8(m128, mm_round_ps, (const m128& a), (a, imm8))
ywstd_intrin_macro_imm8(m256, mm256_round_ps, (const m256& a), (a, imm8))
ywstd_intrin_macro_imm8(m128d, mm_round_sd, (const m128d& a, const m128d& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m128, mm_round_ss, (const m128& a, const m128& b), (a, b, imm8))

ywstd_intrin_macro(m128d, mm_svml_ceil_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_svml_ceil_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_svml_ceil_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_svml_ceil_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_svml_floor_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_svml_floor_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_svml_floor_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_svml_floor_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_svml_round_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_svml_round_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_svml_round_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_svml_round_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_trunc_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_trunc_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_trunc_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_trunc_ps, (const m256& a), (a))

ywstd_intrin_macro(void, mm_maskmoveu_si128, (const m128i& a, const m128i& mask, char* mem_addr), (a, mask, mem_addr))
// ywstd_intrin_macro(void, mm256_maskmoveu_si256, (const m256i& a, const m256i& mask, char* mem_addr), (a, mask, mem_addr))
ywstd_intrin_macro(void, mm_maskstore_epi32, (int* mem_addr, const m128i& mask, const m128i& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm256_maskstore_epi32, (int* mem_addr, const m256i& mask, const m256i& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm_maskstore_epi64, (__int64* mem_addr, const m128i& mask, const m128i& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm256_maskstore_epi64, (__int64* mem_addr, const m256i& mask, const m256i& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm_maskstore_pd, (double* mem_addr, const m128i& mask, const m128d& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm256_maskstore_pd, (double* mem_addr, const m256i& mask, const m256d& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm_maskstore_ps, (float* mem_addr, const m128i& mask, const m128& a), (mem_addr, mask, a))
ywstd_intrin_macro(void, mm256_maskstore_ps, (float* mem_addr, const m256i& mask, const m256& a), (mem_addr, mask, a))

ywstd_intrin_macro(void, mm_store_si128, (m128i* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_store_si256, (m256i* mem_addr, const m256i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_store_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_store_pd, (double* mem_addr, const m256d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_store_ps, (float* mem_addr, const m128& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_store_ps, (float* mem_addr, const m256& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_store_sd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_store_ss, (float* mem_addr, const m128& a), (mem_addr, a))

ywstd_intrin_macro(void, mm_store1_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_store1_ps, (float* mem_addr, const m128& a), (mem_addr, a))

ywstd_intrin_macro(void, mm_storeh_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storel_epi64, (m128i* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storel_pd, (double* mem_addr, const m128d& a), (mem_addr, a))

ywstd_intrin_macro(void, mm_storer_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storer_ps, (float* mem_addr, const m128& a), (mem_addr, a))

ywstd_intrin_macro(void, mm_storeu_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_storeu_pd, (double* mem_addr, const m256d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storeu_ps, (float* mem_addr, const m128& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_storeu_ps, (float* mem_addr, const m256& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storeu_si128, (m128i* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_storeu_si256, (m256i* mem_addr, const m256i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storeu_si16, (void* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storeu_si32, (void* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_storeu_si64, (void* mem_addr, const m128i& a), (mem_addr, a))
...
ywstd_intrin_macro(void, mm_stream_pd, (double* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_stream_pd, (double* mem_addr, const m256d& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_stream_ps, (float* mem_addr, const m128& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_stream_ps, (float* mem_addr, const m256& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_stream_si128, (m128i* mem_addr, const m128i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm256_stream_si256, (m256i* mem_addr, const m256i& a), (mem_addr, a))
ywstd_intrin_macro(void, mm_stream_si32, (int* mem_addr, const int a), (mem_addr, a))
// ywstd_intrin_macro(void, mm_stream_si64, (long long* mem_addr, const __int64 a), (mem_addr, a))

ywstd_intrin_macro_imm8(int, mm_cmpestra, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpestrc, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpestri, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(m128i, mm_cmpestrm, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpestro, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpestrs, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpestrz, (const m128i& a, int la, const m128i& b, int lb), (a, la, b, lb, imm8))

ywstd_intrin_macro_imm8(int, mm_cmpistra, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpistrc, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpistri, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m128i, mm_cmpistrm, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpistro, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpistrs, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(int, mm_cmpistrz, (const m128i& a, const m128i& b), (a, b, imm8))

ywstd_intrin_macro_imm8(m128i, mm_blend_epi16, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_blend_epi16, (const m256i& a, const m256i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m128i, mm_blend_epi32, (const m128i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_blend_epi32, (const m256i& a, const m256i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m128d, mm_blend_pd, (const m128d& a, const m128d& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_blend_pd, (const m256d& a, const m256d& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m128, mm_blend_ps, (const m128& a, const m128& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256, mm256_blend_ps, (const m256& a, const m256& b), (a, b, imm8))

ywstd_intrin_macro(m128i, mm_blendv_epi8, (const m128i& a, const m128i& b, const m128i& mask), (a, b, mask))
ywstd_intrin_macro(m256i, mm256_blendv_epi8, (const m256i& a, const m256i& b, const m256i& mask), (a, b, mask))
ywstd_intrin_macro(m128d, mm_blendv_pd, (const m128d& a, const m128d& b, const m128d& mask), (a, b, mask))
ywstd_intrin_macro(m256d, mm256_blendv_pd, (const m256d& a, const m256d& b, const m256d& mask), (a, b, mask))
ywstd_intrin_macro(m128, mm_blendv_ps, (const m128& a, const m128& b, const m128& mask), (a, b, mask))
ywstd_intrin_macro(m256, mm256_blendv_ps, (const m256& a, const m256& b, const m256& mask), (a, b, mask))

ywstd_intrin_macro_imm8(m128i, mm_extract_epi8, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extract_epi8, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_extract_epi16, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extract_epi16, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_extract_epi32, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extract_epi32, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128i, mm_extract_epi64, (const m128i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extract_epi64, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m128, mm_extract_ps, (const m128& a), (a, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_extractf128_pd, (const m256d& a), (a, imm8))
ywstd_intrin_macro_imm8(m256, mm256_extractf128_ps, (const m256& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extractf128_si256, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_extracti128_si256, (const m256i& a), (a, imm8))

ywstd_intrin_macro_imm8(m128i, mm_insert_epi8, (const m128i& a, const int i), (a, i, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_insert_epi8, (const m256i& a, const __int8 i), (a, i, imm8))
ywstd_intrin_macro_imm8(m128i, mm_insert_epi16, (const m128i& a, const int i), (a, i, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_insert_epi16, (const m256i& a, const __int16 i), (a, i, imm8))
ywstd_intrin_macro_imm8(m128i, mm_insert_epi32, (const m128i& a, const int i), (a, i, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_insert_epi32, (const m256i& a, const __int32 i), (a, i, imm8))
ywstd_intrin_macro_imm8(m128i, mm_insert_epi64, (const m128i& a, const __int64 i), (a, i, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_insert_epi64, (const m256i& a, const __int64 i), (a, i, imm8))
ywstd_intrin_macro_imm8(m128, mm_insert_ps, (const m128& a, const m128& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_insertf128_pd, (const m256d& a, const m128d& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256, mm256_insertf128_ps, (const m256& a, const m128& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_insertf128_si256, (const m256i& a, const m128i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_inserti128_si256, (const m256i& a, const m128i& b), (a, b, imm8))

ywstd_intrin_macro_imm8(m128d, mm_permute_pd, (const m128d& a), (a, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_permute_pd, (const m256d& a), (a, imm8))
ywstd_intrin_macro_imm8(m128, mm_permute_ps, (const m128& a), (a, imm8))
ywstd_intrin_macro_imm8(m256, mm256_permute_ps, (const m256& a), (a, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_permute2f128_pd, (const m256d& a, const m256d& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256, mm256_permute2f128_ps, (const m256& a, const m256& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_permute2f128_si256, (const m256i& a, const m256i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_permute2x128_si256, (const m256i& a, const m256i& b), (a, b, imm8))
ywstd_intrin_macro_imm8(m256i, mm256_permute4x64_epi64, (const m256i& a), (a, imm8))
ywstd_intrin_macro_imm8(m256d, mm256_permute4x64_pd, (const m256d& a), (a, imm8))
ywstd_intrin_macro(m128d, mm_permutevar_pd, (const m128d& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256d, mm256_permutevar_pd, (const m256d& a, const m256i& b), (a, b))
ywstd_intrin_macro(m128, mm_permutevar_ps, (const m128& a, const m128i& b), (a, b))
ywstd_intrin_macro(m256, mm256_permutevar_ps, (const m256& a, const m256i& b), (a, b))
ywstd_intrin_macro(m256i, mm256_permutevar8x32_epi32, (const m256i& a, const m256i& idx), (a, idx))

ywstd_intrin_macro(m128d, mm_sin_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_sin_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_sin_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_sin_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_cos_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_cos_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_cos_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_cos_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_tan_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_tan_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_tan_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_tan_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_asinh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_asinh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_asinh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_asinh_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_acos_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_acos_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_acos_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_acos_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_atan_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_atan_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_atan_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_atan_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_atan2_pd, (const m128d& a, const m128d& b), (a, b))
ywstd_intrin_macro(m256d, mm256_atan2_pd, (const m256d& a, const m256d& b), (a, b))
ywstd_intrin_macro(m128, mm_atan2_ps, (const m128& a, const m128& b), (a, b))
ywstd_intrin_macro(m256, mm256_atan2_ps, (const m256& a, const m256& b), (a, b))

ywstd_intrin_macro(m128d, mm_sincos_pd, (m128d* mem_addr, const m128d& a), (mem_addr, a))
ywstd_intrin_macro(m256d, mm256_sincos_pd, (m256d* mem_addr, const m256d& a), (mem_addr, a))
ywstd_intrin_macro(m128, mm_sincos_ps, (m128* mem_addr, const m128& a), (mem_addr, a))
ywstd_intrin_macro(m256, mm256_sincos_ps, (m256* mem_addr, const m256& a), (mem_addr, a))

ywstd_intrin_macro(m128d, mm_sinh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_sinh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_sinh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_sinh_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_cosh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_cosh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_cosh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_cosh_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_tanh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_tanh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_tanh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_tanh_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_asin_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_asin_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_asin_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_asin_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_acosh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_acosh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_acosh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_acosh_ps, (const m256& a), (a))

ywstd_intrin_macro(m128d, mm_atanh_pd, (const m128d& a), (a))
ywstd_intrin_macro(m256d, mm256_atanh_pd, (const m256d& a), (a))
ywstd_intrin_macro(m128, mm_atanh_ps, (const m128& a), (a))
ywstd_intrin_macro(m256, mm256_atanh_ps, (const m256& a), (a))
}
