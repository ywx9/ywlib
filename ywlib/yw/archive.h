...
namespace yw {
namespace internal {
inline constexpr uint32_t archive_entry_magic = 0x45415759;  // 'YWAE'
inline constexpr uint32_t archive_footer_magic = 0x46415759; // 'YWAF'
inline constexpr uint32_t archive_max_name_size = 2048;
} // namespace internal

inline const class {
  template<integral T> static T _to_le(T a) noexcept {
