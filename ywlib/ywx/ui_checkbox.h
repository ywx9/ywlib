...
class checkbox : public clickable_plain {
  static icon_variant _default_off_circle_icon() {
    constexpr float2 vb = {24.0f, 24.0f};
    constexpr std::string_view circle_path = "M 12 2 "
                                             "C 17.5228 2 22 6.4772 22 12 "
                                             "C 22 17.5228 17.5228 22 12 22 "
                                             "C 6.4772 22 2 17.5228 2 12 "
                                             "C 2 6.4772 6.4772 2 12 2 Z";
    if (auto p = svgpath::create(vb, circle_path)) return icon_variant(std::move(*p));
    return icon_variant(std::monostate{});
  }

  static icon_variant _default_on_circle_icon() {
    constexpr float2 vb = {24.0f, 24.0f};
    constexpr std::string_view circle_path = "M 12 6 "
